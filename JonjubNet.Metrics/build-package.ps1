# Script para construir y empaquetar JonjubNet.Metrics
param(
...
Write-Host "Construyendo JonjubNet.Metrics v$Version" -ForegroundColor Green
...
Write-Host "dotnet nuget push ./packages/JonjubNet.Metrics.$Version.nupkg --api-key YOUR_API_KEY --source https://api.nuget.org/v3/index.json" -ForegroundColor White
