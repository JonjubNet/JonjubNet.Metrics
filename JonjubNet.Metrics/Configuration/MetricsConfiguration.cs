namespace JonjubNet.Metrics.Configuration
{
    ...
    public class TimerServiceConfiguration
    {
        ...
        /// </summary>
        public MetricsFiltersConfiguration Filters { get; set; } = new();
    }

    /// <summary>
    /// Configuración específica por tipo de métrica
    /// </summary>
    public class MetricsTypeConfiguration
    {
        /// <summary>
        /// Habilitar este tipo de métrica
        /// </summary>
        public bool Enabled { get; set; } = true;

        /// <summary>
        /// Intervalo de muestreo en milisegundos (0 = sin muestreo)
        /// </summary>
        public int SamplingIntervalMs { get; set; } = 0;

        /// <summary>
        /// Límite de métricas por minuto (0 = sin límite)
        /// </summary>
        public int RateLimitPerMinute { get; set; } = 0;

        /// <summary>
        /// Habilitar agregación de métricas
        /// </summary>
        public bool EnableAggregation { get; set; } = false;

        /// <summary>
        /// Tamaño del lote para envío (0 = envío individual)
        /// </summary>
    ...
    /// </summary>
    public class MetricsEndpointsConfiguration
    {
        /// <summary>
        /// Endpoint para métricas técnicas
        /// </summary>
        public string Technical { get; set; } = "/api/metrics/technical";

        /// <summary>
        /// Endpoint para métricas funcionales
        /// </summary>
        public string Functional { get; set; } = "/api/metrics/functional";

        /// <summary>
        /// Endpoint para métricas operativas
        /// </summary>
        public string Operational { get; set; } = "/api/metrics/operational";

        /// <summary>
        /// Endpoint para métricas de salud
        /// </summary>
        public string Health { get; set; } = "/api/metrics/health";

        /// <summary>
        /// Endpoint para métricas personalizadas
        /// </summary>
        public string Custom { get; set; } = "/api/metrics/custom";
    }

    /// <summary>
    /// Configuración de filtros y exclusiones
    /// </summary>
    public class MetricsFiltersConfiguration
    {
        /// <summary>
        /// Patrones de endpoints a excluir (ej: "/health", "/swagger")
        /// </summary>
        public List<string> ExcludedEndpoints { get; set; } = new();

        /// <summary>
        /// Patrones de operaciones a excluir
        /// </summary>
        public List<string> ExcludedOperations { get; set; } = new();

        /// <summary>
        /// Tiempo mínimo de ejecución para registrar métricas (ms)
        /// </summary>
        public int MinExecutionTimeMs { get; set; } = 0;

        /// <summary>
        /// Habilitar filtrado por códigos de estado HTTP
        /// </summary>
        public bool FilterByStatusCode { get; set; } = false;

        /// <summary>
        /// Códigos de estado HTTP a excluir
        /// </summary>
