...
namespace JonjubNet.Metrics.Shared.Health
{
    /// <summary>
    ...
    public class MetricsHealthCheck : IMetricsHealthCheck
    {
        ...
        public MetricsHealthCheck(
            ...
            Microsoft.Extensions.Options.IOptions<JonjubNet.Metrics.Shared.Configuration.MetricsOptions>? options = null,
        ...
        public MetricsHealthStatus CheckBusHealth()
        {
            // ELIMINADO: Bus ya no se usa - todos los sinks leen del Registry
            // Retornar estado saludable ya que no hay Bus que monitorear
            return new MetricsHealthStatus
            {
                IsHealthy = true,
                Message = "MetricBus eliminated - all sinks read directly from Registry (optimized architecture)"
            };
        }
        ...
        public OverallMetricsHealth GetOverallHealth()
        {
            ...
            var isHealthy = busHealth.IsHealthy &&
