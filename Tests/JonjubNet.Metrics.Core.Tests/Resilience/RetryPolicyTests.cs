...
namespace JonjubNet.Metrics.Core.Tests.Resilience
{
    public class RetryPolicyTests
    {
        [Fact]
        public void ExecuteAsync_ShouldSucceedOnFirstAttempt()
        {
            // Arrange
        ...
        [Fact]
        public void ExecuteAsync_ShouldRetryOnFailure()
        {
            // Arrange
        ...
        [Fact]
        public void ExecuteAsync_ShouldThrowAfterMaxRetries()
        {
            // Arrange
        ...
        [Fact]
        public void ExecuteAsync_Action_ShouldSucceed()
        {
            // Arrange
            var policy = new RetryPolicy(maxRetries: 3);
            var callCount = 0;
        ...
        [Fact]
        public void ExecuteWithResultAsync_ShouldReturnSuccessResult()
        {
            // Arrange
            var policy = new RetryPolicy(maxRetries: 3);
            var callCount = 0;
        ...
        [Fact]
        public void ExecuteWithResultAsync_ShouldRetryAndReturnFailureResult()
        {
            // Arrange
            var policy = new RetryPolicy(maxRetries: 2, initialDelay: TimeSpan.FromMilliseconds(10));
            var callCount = 0;
