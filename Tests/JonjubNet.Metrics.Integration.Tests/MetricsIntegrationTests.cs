...
namespace JonjubNet.Metrics.Integration.Tests
{
    public class MetricsIntegrationTests
    {
        ...
        [Fact]
        public async Task MetricBus_WithSink_ShouldExport()
        {
            // Arrange
            ...
            {
                points.Add(new MetricPoint(evt.Name, evt.Type, evt.Value, evt.Tags));
            }

            // Assert
            points.Should().HaveCount(1);
            points[0].Name.Should().Be("test_metric");
        }
